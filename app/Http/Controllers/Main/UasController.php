...
class UasController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->user_jab_id == 1) {
            ...
            $tugas = NilaiUas::with('mapel', 'siswa', 'user', 'tahun_akademik', 'semester')->get();
        } else {
            // Jika bukan admin, ambil data berdasarkan user_id
            $userID = $user->user_id;
            $tugas = NilaiUas::with('mapel', 'siswa', 'user', 'tahun_akademik', 'semester')
                ->where('user_id', $userID)
                ->get();
        }

        $data['title'] = "Nilai UAS";
        $data['result'] = $tugas->sortByDesc('created_at');

        return view("main.uas.index", $data);
    }
    ...
    public function create()
    {
        ...
        $data['title'] = "Create Nilai UAS";
        return view("main.uas.create", $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('main/uas')->with('success', 'Data berhasil disimpan!');
    }
    ...
    public function edit(string $id)
    {
        ...
        $data['mapel'] = Mapel::all();
        $data['siswa'] = Siswa::all();
        $data['title'] = "Edit Nilai UAS";
        $data['result'] = NilaiUas::findOrFail($id);
        return view("main.uas.edit", $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('main/uas')->with('success', 'Data berhasil diubah!');
    }
