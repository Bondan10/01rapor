            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('nilai_harian.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Mapel</label>
                                    <select name="mapel_id" id="mapel_id" class="form-control mapel" required>
                                        {{-- <option value="">-</option> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pertemuan" class="form-control" placeholder="pertemuan"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label>Nilai</label>
