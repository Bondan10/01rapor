...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/nilai_harian/create') }}" class="btn btn-primary">Create Data</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->nilai }}</td>
                                            <td>
                                                <a href="/main/nilai_harian/{{ $row->nilai_harian_id }}/edit"
                                                    class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('nilai_harian.destroy', $row->nilai_harian_id) }}"
