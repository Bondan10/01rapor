...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/semester/create') }}" class="btn btn-primary">Create</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/main/semester/{{ $row->semester_id }}/edit"
                                                    class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                {{-- <a href="{{ url('main/semester/destroy/' . $row->semester_id) }}"
                                                    onclick="return confirm('Are you sure?'); return false;"
                                                    class="btn btn-danger"><i class="fa fa-trash"></i></a> --}}
                                                <form action="{{ route('semester.destroy', $row->semester_id) }}"
