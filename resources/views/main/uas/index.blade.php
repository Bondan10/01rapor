...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/uas/create') }}" class="btn btn-primary">Create Data</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->nilai }}</td>
                                            <td>
                                                <a href="/main/uas/{{ $row->uas_id }}/edit" class="btn btn-warning"><i
                                                        class="fa fa-edit"></i></a>
                                                <form action="{{ route('uas.destroy', $row->uas_id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('delete')
