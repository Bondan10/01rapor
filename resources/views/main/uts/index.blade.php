...
@section('content')
    <div class="container-fluid" style="padding-left: 1%;">
        <a href="{{ url('main/uts/create') }}" class="btn btn-primary">Create Data</a>
    </div>
    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($result as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->nilai }}</td>
                                            <td>
                                                <a href="/main/uts/{{ $row->uts_id }}/edit" class="btn btn-warning"><i
                                                        class="fa fa-edit"></i></a>
                                                <form action="{{ route('uts.destroy', $row->uts_id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('delete')
